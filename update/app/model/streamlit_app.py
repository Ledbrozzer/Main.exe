...
abastecimento_df['Km/LtA'] = abastecimento_df['Dif Km'] / abastecimento_df['Litros Anterior']
abastecimento_df['Hr/LtA'] = abastecimento_df['Litros Anterior'] / abastecimento_df['Dif Hr']
abastecimento_df['Km/LtA'] = abastecimento_df['Km/LtA'].round(3)
abastecimento_df['Hr/LtA'] = abastecimento_df['Hr/LtA'].round(3)
abastecimento_df['Km/Lt'] = abastecimento_df['Dif Km'] / abastecimento_df['Litros']
abastecimento_df['Hr/Lt'] = abastecimento_df['Litros'] / abastecimento_df['Dif Hr']
abastecimento_df['Km/Lt'] = abastecimento_df['Km/Lt'].round(3)
abastecimento_df['Hr/Lt'] = abastecimento_df['Hr/Lt'].round(3)
abastecimento_df['Combustível Restante A'] = abastecimento_df['Dif Km'] % abastecimento_df['Litros Anterior']
abastecimento_df['Combustível Restante A'] = abastecimento_df['Combustível Restante A'].round(3)
abastecimento_df['Combustível Restante'] = abastecimento_df['Dif Km'] % abastecimento_df['Litros']
...
abastecimento_df['(Hr/LtA)Gás'] = abastecimento_df['Hr/LtA'] * abastecimento_df['Gás Anterior']
abastecimento_df['(Hr/Lt)Gás'] = abastecimento_df['Hr/Lt'] * abastecimento_df['Gás Anterior']#Add coluns'PLACA/','Tipo','Modelo'|'Base'aoDataFrame d-abastecimento
...
colunas_ordem = ["Data", "Motorista", "PLACA/", "(Hr/Lt)Gás", "Km/Lt", "Hr/Lt", "(Hr/LtA)Gás", "Km/LtA", "Hr/LtA", "Dif Km", "Dif Hr", "KmAtual", "Horas", "Litros", "Litros Anterior", "Gás Anterior", "Combustível Restante", "Combustível Restante A", "Custo Gás", "Veículo/Equip.", "Km Rodados", "Gás", "Alt Diesel", "Tipo", "Modelo", "Base", "ID Req", "Obs."]
